...
<head>
  ...
  <link rel="stylesheet" href="/site/css/userAccount_style.css">
</head>

<body>

  <div class="one"> <div class="one_one"><p1>VR StoryGram Educator</p1></div> <div class="one_icon"><img src="/site/img/default_profile.png"></div> </div>
  <div class="two"> <div class="two_image"><img src="/site/img/default_profile.png"></div> <div class="two_space1"></div>  <div class="two_username"><p1><?php include "login_script.php"; $user_name = $_GET["name"]; echo $user_name; ?></p1></div> <div class="two_bio"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p></div>
