...
<body>
  ...
  <div class="one"> <div class="one_one"><p1>VR StoryGram</p1></div> <div class="one_icon"><img src="/img/default_profile.png"></div> </div>
  <div class="two"> <div class="two_image"><img src="/img/default_profile.png"></div> <div class="two_space1"></div>  <div class="two_username"><p1>UserName</p1></div> <div class="two_bio"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p></div>
